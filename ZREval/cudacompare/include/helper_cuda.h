...
inline int findCudaDevice(int argc, const char **argv)
{
    ...
    {
      fprintf(stdout, "REV: matched device\n");
        devID = getCmdLineArgumentInt(argc, argv, "device=");
	fprintf(stdout, "REV: got device id %d\n", devID);
        if (devID < 0)
        {
        ...
        {
	  fprintf(stdout, "Trying to get dev...\n");
            devID = gpuDeviceInit(devID);
	    fprintf(stdout, "Got dev id ret val %d...\n", devID);
    ...
    {
      fprintf(stdout, "REV: And, here I am\n");
